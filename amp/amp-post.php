...
.single-article .article-content-txt{font-size:15px;}
...
.single-article .article-content { border: solid 10px #e7e7e7; }
...
.single-article .offre-card .info-offre { margin-bottom:0; margin-top: 0; font-size:15px;}
...
.single-article .prev-article-btn { position: relative; font-size: 15px; font-weight: 700; }
.single-article .next-article-btn { position: relative; font-size: 15px; font-weight: 700; }
.single-article .article-back-btn { position: relative; font-size: 15px; font-weight: 700; }
.single-article .page-title { position: relative; }
.single-article .offre-title { position: relative; min-height: 150px; display: flex; flex-direction: column; position: relative; }
...
.single-article .offre-title p.name-offre { margin-top: 40px; }
.single-article .offre-title p.ref-offre { margin-top: 0; padding-bottom: 10px }
		...
		the_post(); ?>
			<div class="main single-article">
					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 text-center page-share mt-1 mb-2">
								<a class="d-inline-block mx-2" href="https://plus.google.com/share?url=<?php echo get_permalink();?>" target="_blank"><amp-img layout="fixed" width="20" height="20" src="<?php echo get_template_directory_uri(); ?>/img/share-google.png"></amp-img></a>
								<a class="d-inline-block mx-2" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo get_template_directory_uri(); ?>" target="_blank" ><amp-img layout="fixed" width="20" height="20" src="<?php echo get_template_directory_uri(); ?>/img/share-facebook.png"></amp-img></a>
								<a class="d-inline-block mx-2" href="https://twitter.com/intent/tweet?text=%20&url=<?php echo get_permalink();?>" target="_blank"><amp-img layout="fixed" width="20" height="20" src="<?php echo get_template_directory_uri(); ?>/img/share-twitter.png"></amp-img></a>
								<a class="d-inline-block mx-2" href="https://www.linkedin.com/shareArticle?url=<?php echo get_template_directory_uri(); ?>" target="_blank" ><amp-img layout="fixed" width="20" height="20" src="<?php echo get_template_directory_uri(); ?>/img/share-linkedin.png"></amp-img></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 text-center article-share mb-2">
								...
								<a href="https://twitter.com/intent/tweet?text=%20&url=<?php echo get_permalink();?>" target="_blank" class="mx-2 d-inline-block"><amp-img layout="fixed" width="20" height="20" src="<?php echo get_template_directory_uri(); ?>/img/share-twitter.png"></amp-img></a>
								<a href="https://www.linkedin.com/shareArticle?url=<?php echo get_template_directory_uri(); ?>" target="_blank" class="mx-2 d-inline-block"><amp-img layout="fixed" width="20" height="20" src="<?php echo get_template_directory_uri(); ?>/img/share-linkedin.png"></amp-img></a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class=row>
							<div class="col-12">
								...
								<?php foreach ($recent_posts as $article) { ?>
									<div class="article-card col-12 my-1">
										<a class="d-block" href="<?php echo get_permalink($article['ID']); ?>/amp">
											<div class="row bg-white">
												...
												<?php } else{ ?>
													<div class="col-12 post-thumbnail-container">
														<amp-img layout="responsive" width="700" height="200" src="<?php echo get_template_directory_uri(); ?>/img/actu-thumb.png"></amp-img>
													</div>
												<?php } ?>
												<div class="col-12 py-1 post-info-container">
													<div class="d-flex px-1 post-infos">
						...
						<div class="row px-1">
							...
							<div class="col-12">
								<div class="row">
									...
									<div class="offre-card col-12 mb-1 mt-2">
										<a class="d-block" href="<?php echo get_permalink($offer); ?>/amp">
											<div class="row px-1">
												...
												<div class="col-12 bg-white text-black offre-infos">
													<?php if(get_field('contrat', $offer)){ ?>
														<p class="px-1 pb-1 info-offre">Contrat : <em><?php echo get_field('contrat', $offer); ?></em></p>
													<?php }
													if(get_field('fonction', $offer)){ ?>
														<p class="px-1 pb-1 info-offre">Fonction : <em><?php echo get_field('fonction', $offer); ?></em></p>
													<?php }
													if(get_field('secteur', $offer)){ ?>
														<p class="px-1 pb-1 info-offre">Secteur : <em><?php echo get_field('secteur', $offer); ?></em></p>
													<?php }
													if(get_field('salary-min', $offer) && get_field('salary-max', $offer)){ ?>
														<p class="px-1 pb-1 info-offre">Salaire (€/an) : <em><?php echo get_field('salary-min', $offer); ?> à <?php echo get_field('salary-max', $offer); ?></em></p>
													<?php }
													if(get_field('city', $offer) && get_field('pays', $offer)){ ?>
														<p class="px-1 pb-1 info-offre">Localisation : <em><?php echo get_field('city', $offer); ?> (<?php echo get_field('pays', $offer); ?>)</em></p>
													<?php }
													if(get_field('descrassignement', $offer)){
														...
														if(count($descrSplit)==2){ ?>
															<div class="px-1 pb-1 offre-update my-1"><?php echo $descrSplit[0]; ?></div>
														<?php }
														else{ ?>
															<div class="px-1 pb-1 offre-update my-1"><?php echo substr(get_field('descrassignement', $offer), 0, 140)."[...]"; ?></div>
														<?php }
													}?>
												</div>
											</div>
				...
				<div class="col2-bg-black-white font-weight-bold">
					<div class="">
						<div class="row">
							<div class="col-12 col-lg-6 savoir-plus bg-white text-black text-uppercase">
							...
							<div class="col-12 col-lg-6 bg-black candidature-spont text-white">
								<div class="row py-2 px-2">
